...
interface ProductService {
    ...
    fun create(name: String, description: String, picture_url: String?, category: String?, price: Float, average_rating: Float, creation_date: Date) : ProductDTO
    fun updateFull(productId: Long, name: String, description: String, picture_url: String, category: String, price: Float, average_rating: Float, creation_date: Date) : ProductDTO
